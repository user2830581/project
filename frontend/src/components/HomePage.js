      ...
      <main>
        ...
        <section className="info-section">
          <div className="figures-section">
            ...
            <div className="figure">
              <h1>25%</h1>
              <p>
                Of carbon emissions are captured by forests. Protecting forests
                is essential for carbon sequestration.
              </p>
            </div>
            <div className="figure">
              <h1>50%</h1>
            ...
            <div className="carbon-sub-sections">
              ...
              <div className="carbon-text">
                ...
                <p>
                  ...
                  captured and stored in vegetation like forests, grasslands,
                  and other ecosystems. This lowers the concentration of CO2 in
                  the environment, reducing its effect as a greenhouse gas.
                  These carbon reserves are referred to as carbon stocks and are
                  a key contributor in reducing the impact of climate change.
                </p>
              </div>
              <div className="carbon-text">
                ...
                <p>
                  ...
                  76% of global greenhouse gas emissions. Carbon sequestration
                  is essential for reducing CO2 levels because carbon dioxide is
                  a gas that does not break down easily and can remain in the
              ...
              <div className="carbon-text">
                ...
                <p>
                  ...
                  global warming, such as rising temperatures, increased
                  droughts, and food shortages, can be reduced by maintaining
                  and expanding our forests.
                </p>
              </div>
            </div>
        ...
        <section className="features-section">
          <div className="features-section-title">
            ...
            <p>
              By leveraging tree data, we can give users an intuitive breakdown
              of their information to guide sustainability practices.
            </p>
          </div>
          <div className="features-list">
            ...
            <div className="feature">
              ...
              <p>
                ...
                <br />
                <br />
                This helps to identify patterns in carbon levels and allows
                users to make informed decisions with sustainability practices.
              </p>
            </div>
            <div className="feature">
              <div className="feature-title">
              ...
              <p>
                ...
                <br />
                <br />
                By regularly updating and reviewing data, users can track
                changes.
                <br />
                <br />
                The system gives users informative feedback and visualizations
                on their data to view the long term impact of their
                contributions.
              </p>
            </div>
          </div>
